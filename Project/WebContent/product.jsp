...
<body>
	...
	<div class="container header">
		...
		<div class="nav">
			...
			<ul>
				...
				<li class="current"><a href="${ctx }/product.jsp">关键词统计</a></li>
	...
	<div class="container content">
		...
		<div class="right">
			<div class="breadcrumbs"><img src="${ctx }/images/home-icon.gif" width="16" height="17" alt="首页" />当前位置：<a href="before_index.jsp">首页</a><span>></span><span>关键词统计</span></div>
			<div class="about">
				<div class="show" title="cat1">
					...
					<script type="text/javascript">
						...
						$.get('${ctx }/data/productjson', function (data) {
							console.log(data);
